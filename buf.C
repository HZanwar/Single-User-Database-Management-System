...
const Status BufMgr::flushFile(const File* file) 
{
  ...
  // This method will be called by DB::closeFile() when all instances of a file have been closed (in which case
  //all pages of the file should have been unpinned). flushFile() should scan bufTable for pages belonging to
  //the file.
...
const Status BufMgr::allocPage(File* file, int& pageNo, Page*& page) 
{
   ...
   // This method will return the page number of the newly allocated page. Then allocBuf() is called to obtain a buffer
   //pool frame. Next, an entry is inserted into the hash table and Set() is invoked on the frame to set it up properly.
   //The method returns both the page number of the newly allocated page to the caller via the pageNo parameter and a pointer
   // to the buffer frame allocated for thepage via the page parameter.
